...
python scripts/self_demo_inference.py --cfg configs/halpe_136/resnet/self.yaml --checkpoint pretrained_models/self_model.pth --video ~/autodl-tmp/How2Sign/videos/  --chdir ./examples/res/ --format cmu
```
