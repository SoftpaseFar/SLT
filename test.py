...
if __name__ == '__main__':
    video_paths = None
    videos_dir = './data/How2Sign/videos'
    if videos_dir:
    ...
    file_name = os.path.splitext(os.path.basename("./data/How2Sign/videos/-g0iPSnQt6w_4-1-rgb_front.mp4"))[0]
    print(file_name)

    print(os.path.basename("./data/How2Sign/videos/-g0iPSnQt6w_4-1-rgb_front.mp4"))
    # pose_keypoints_2d =[]
